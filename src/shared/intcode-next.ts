...
export type feedback =
  | { type: feedbackType.HALT }
  | { type: feedbackType.INPUT }
  | { type: feedbackType.OUTPUT; output: number };

export function* intcodeNext(
  programBase: number[]
): Generator<feedback, { type: undefined; state: number[] }, number> {
  ...
  return { type: undefined, state: program };
